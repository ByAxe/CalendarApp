...
-- ГРУППЫ --
INSERT INTO cld.groups (uuid, dt_update, title, specialization, qualification, description, number, hours, ruler_id)
VALUES
  ('1d5caa06-6fe9-46b7-92a3-6360ba867ac8', CURRENT_TIMESTAMP(2), 'Техники-сантехники', 'Экономическая деятельность',
   'Технология разработки сантехнического обеспечения', 'Техники сантехники. Такая группа когда то была.', '143ТС', 120,
   1);
INSERT INTO cld.groups (uuid, dt_update, title, specialization, qualification, description, number, hours, ruler_id)
VALUES
  ('1655a2ad-e7b8-47a0-a17a-949dd1627493', CURRENT_TIMESTAMP(2), 'Мехатроники', 'Изобретение приборов',
   'Технология разработки изобретения механизмов', 'Техники приборостроители. Такая группа когда то была.', '101ИП',
   333, 2);
INSERT INTO cld.groups (uuid, dt_update, title, specialization, qualification, description, number, hours, ruler_id)
VALUES
  ('f9da9b76-6ed1-4199-ad3b-eefedaaf8f84', CURRENT_TIMESTAMP(2), 'Космонавты', 'Полеты на марс',
   'Технология прибытия в иные миры', 'Техники исследовтели. Такая группа когда то была.', '007МИ',
   10000, 3);
...
-- РАСПРЕДЕЛЕНИЕ --
INSERT INTO cld.allocation (uuid, dt_update, group_id, organisation_id, student_id, order_id, confirmations)
VALUES ('7ee16dd5-5b51-42a8-994b-b3da13b7f9f6', current_timestamp(2), 1, 1, 1, 1,
        ARRAY ['', '', '', '', '', '', '', '', '', '']);
INSERT INTO cld.allocation (uuid, dt_update, group_id, organisation_id, student_id, order_id, confirmations)
VALUES ('6ca78147-1a30-497c-8d15-6fd0d35e1137', current_timestamp(2), 2, 1, 2, 1,
        ARRAY ['Работает', '', '', '', '', '', '', '', '', '']);
INSERT INTO cld.allocation (uuid, dt_update, group_id, organisation_id, student_id, order_id, confirmations, archive)
VALUES ('e22dbe92-0169-4bc2-86dc-9c76590b21e3', current_timestamp(2), 3, 2, 3, 1,
