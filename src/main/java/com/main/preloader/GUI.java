...
public class GUI extends Application implements ChangeListener<Number> {
    ...
    /**
     * Build all the com.main component of this animation
     *
     * @throws IOException
     */
    public void buildComponents() throws IOException {
        ...
        scene = new Scene(g, 685, 500, Color.WHITE);
    }
    ...
    /**
     * This is the com.main update function which is triggered from preloader class
