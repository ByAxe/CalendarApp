...
import static com.core.enums.ResultEnum.ERROR;
...
public class Utils {
     ...
     * <p>
     * В случае Успеха (пустой errors) возвращает {@link Result} где лежит {@link com.core.enums.ResultEnum.SUCCESS},
     * payload {@link List<String>} == null
     * </p>
     * <p>
     * В случае Ошибок (не пустой errors) возвращает {@link Result} где лежит {@link com.core.enums.ResultEnum.ERROR},
     ...
     * id попадает в строку, благодаря {@link com.core.api.IVisible} методу
     *
     * @param source
     * @return
     */
